...
if slow_mode == "y" or "":
    ...
    acc_step, dec_step, vec_step = 20000, 20000, 10000
    ...
    while cam.motor_egg_count <= mode:
        ...
        if not centers :
            ...
            for center in centers:
                ...
                # --- inhold egg ---
                motor.set_out(0, 1)
                motor.move_MODE_P(2, motor.z_pick_pos, 12000, 12000, 3000, wait=True)
                # time.sleep(1)
                # cam.take_photo()
                ...
                motor.move_MODE_P(2, motor.z_place_pos, 12000, 12000, 3000, wait=True)
                time.sleep(1)
                # cam.take_photo()
