...
# 图片保存路径
IMG_SAVE_PATH = "C:/Users/User/Desktop/Cheng_Yu/control_code/transplant_system_cheng_yu/camera_callibration/data/"
IMG_RESULT_PATH = "C:/Users/User/Desktop/Cheng_Yu/control_code/transplant_system_cheng_yu/camera_callibration/data/"
...
if __name__ == '__main__':
    ...
    for i, name in enumerate(images):
        print('name:', name)
        img = cv2.imread(name)
        img = img[50:-200, 500:-500]
        cv2.imwrite('C:/Users/User/Desktop/Cheng_Yu/control_code/transplant_system_cheng_yu/camera_callibration/data/test.jpg', img)
        ...
        cv2.imshow('img', img)
        cv2.imwrite('C:/Users/User/Desktop/Cheng_Yu/control_code/transplant_system_cheng_yu/camera_callibration/data/output.jpg', img)
        cv2.waitKey(500)
